            ...
            <div class="col-12 col-md-6 mb-4" data-aos="fade-right">
                <a href="{{route('ticketbooking')}}">
                    <div class="cards">
                        ...
                        <div class="info">
                            <h3>Storm Eye</h3>
                            <p>Drop down an elevated chute and spin like a fusilli before splashing into a giant splash
                                pool
            ...
            <div class="col-12 col-md-6 mb-4" data-aos="fade-right">
                <a href="{{route('ticketbooking')}}">
                    <div class="cards">
                        ...
                        <div class="info">
                            <h3>Family Pool</h3>
                            <p>The family pool is the best attraction in the park for the entire family. Be it an adult
                                or a
            ...
            <div class="col-12 col-md-6 mb-4" data-aos="fade-right">
                <a href="{{route('ticketbooking')}}">
                    <div class="cards">
                        ...
                        <div class="info">
                            <h3>Loopy</h3>
                            <p>This one's seriously twisted! Drop down and zoom through the various twists and turns of
                                this
                                very loopy ride.</p>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-6 mb-4" data-aos="fade-left">
                <a href="{{route('ticketbooking')}}">
                    <div class="cards">
                        ...
                        <div class="info">
                            <h3>Yippee Land</h3>
                            <p>Missing Goa and Phuket? Now you can enjoy the pleasures of your very own beach in the
                                heart
            ...
            <div class="col-12 col-md-6 mb-4" data-aos="fade-left">
                <a href="{{route('ticketbooking')}}">
                    <div class="cards">
                        ...
                        <div class="info">
                            <h3>Baby Cool</h3>
                            <p>Why should adults have all the fun? Let your little tots enjoy their day in the sun (and
                                the
            ...
            <div class="col-12 col-md-6 mb-4" data-aos="fade-right">
                <a href="{{route('ticketbooking')}}">
                    <div class="cards">
                        ...
                        <div class="info">
                            <h3>Slow Flow</h3>
                            <p>Tired from all the fun you're having? Need a break? Then how about you hop on a rubber
                                tube
                                and chill out while you go around our lazy river? You can be lazy without missing out on
                                the
                                fun.</p>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-6 mb-4" data-aos="fade-left">
                <a href="{{route('ticketbooking')}}">
                    <div class="cards">
                        ...
                        <div class="info">
                            <h3>Water Wave</h3>
                            <p>Catch the waves and recreate the ambience of the blue waters of the Indian Ocean. Paddle
                                in
                                the shallows or ride the wow inspiring waves with flotation devices. At the end, you
                                come
