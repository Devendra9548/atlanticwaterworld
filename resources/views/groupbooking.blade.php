...
<section class="heading-section pb-5">
    <div class="container">
        <h2 class="mb-3">Group Query Form</h2>
        <p>With its world class rides and safety standards, Atlantic Water World is the perfect destination for group
            outings.
        </p>
        <p class="mb-3">With state-of-the-art facilities and multiple dining options, it's easy to turn school and
            corporate outings
